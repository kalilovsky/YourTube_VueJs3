...
export default {
    ...
    methods: {
        getArticleByUserId() {
            ...
            fetch("./api/index.php?controller=ArticlesController&action=getArticleByUserId&idUser=" + this.idUser, options)
        ...
        deleteArticle: async function (e) {
            ...
            const request = await fetch("./api/index.php?controller=ArticlesController&action=deleteArticle&idArticle=" + idArticle, options)
