  ...
  <div class="cardsManager" @mouseover="handleMouseOver" @mouseleave="handleMouseLeave">
        <router-link :to="'/article/' + this.article.idArticle" ></router-link>
            <div class="imgArticle">
               ...
               <video v-if="article.fileType==='video'" ref="videoElement" :src="'./api/public/articlefile/'+article.filePath" loop muted /> 
               <img v-else :src="'./api/public/articlefile/'+article.filePath" alt="l'article">
            </div>
            <div class="imgUser">
                <div class="resume">
                ...
                <div class="otherDetail">
                    <img :src="'./api/public/userprofile/'+article.profilPhoto" alt="test">
